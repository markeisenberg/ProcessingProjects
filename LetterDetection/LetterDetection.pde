...
void setup() {
  //swap the below line with whatever letter is needed
  //Letters/letter_m.jpg
  //Letters/letter_a.jpg
  //Letters/letter_k.jpg
  //Letters/letter_e.jpg
  //Letters/geks_man.jpg
  opencv = new OpenCV(this, "Letters/letter_e.jpg");
  size(1000, 500);
  src = opencv.getInput();
  ...
  float cellSize = 350/14.0;

  markerCells = new boolean[14][14];
